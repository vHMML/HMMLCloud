...
HMML Cloud is a IIIF hosting service developed by the Hill Museum and Manuscript Library that also can include a simple application that allows digitization and cataloging projects to make their collections visible and searchable to the public.
